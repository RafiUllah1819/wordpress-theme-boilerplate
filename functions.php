<?php
/**
 * ankr_agency functions and definitions
 *
 ...
 */
function ankr_agency_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on ankr_agency, use a find and replace
		* to change 'ankr_agency' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'ankr_agency', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'ankr_agency' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'ankr_agency_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'ankr_agency_setup' );
 ...
 */
function ankr_agency_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'ankr_agency_content_width', 640 );
}
add_action( 'after_setup_theme', 'ankr_agency_content_width', 0 );
 ...
 */
function ankr_agency_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Donation', 'ankr_agency' ),
			'id'            => 'donation',
			'description'   => esc_html__( 'Add widgets here.', 'ankr_agency' ),
...
add_action( 'widgets_init', 'ankr_agency_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function ankr_agency_scripts() {
	...
	wp_enqueue_style( 'ankr_agency-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'ankr_agency-style', 'rtl', 'replace' );
	...
	wp_enqueue_script( 'ankr_agency-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
add_action( 'wp_enqueue_scripts', 'ankr_agency_scripts' );
